...
// 5. The two rules must stay consistent with each other: a suggested bid is
//    always acceptable to the server. This is the invariant a buyer surface
//    depends on, and it spans both functions rather than restating either.
